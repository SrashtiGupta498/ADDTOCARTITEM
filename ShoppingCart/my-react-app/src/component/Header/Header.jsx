...
// import styles from "./Header.module.css";        // default import for CSS-module
// import Logo from "../../assets/logo.png";        // default import for an image file
...
//   }
    ...
    return (
    <header>      
      <nav className="bg-red-900 border border-b-2 border-gray-200 px-2 sm:px-4 py-2 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
